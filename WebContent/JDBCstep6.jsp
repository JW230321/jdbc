...
<%
	...
	String sql ="DROP TABLE test"; // 구문 객체
...
<%
	...
	pstmt.executeUpdate(); // Create, Update, Dlete 즉 가지고 나오는 데이터가 없는 경우 사용
...
C U D 의 경우는 반환되는 데이터가 없다. 따라서 CUD 는 step 6이 생략된다.

하지만 CUD의 경우에도 반환되는 데이터가 존재하기는 한다.
성공했을 경우 1이 반환되고 실패했을 경우에는 0이 반환된다.
